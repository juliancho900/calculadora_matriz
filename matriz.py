...
class Matriz(object):
    ...
    def __init__(self, filas=None, columnas=None):
        ...
        if filas:
            ...
            self.filas=int(raw_input("ingrese el numero de filas "))
        if columnas:
            self.columnas= columnas
        else:
            self.columnas = int(raw_input("ingrese el numero de columnas "))
    ...
    def matriz_det(self,b):
        ...
        if (self.filas != self.columnas):
            print "no se puede hallar el determinante, la matriz no es cuadrada "
            return True
        elif self.filas==2:
                a=1
                b=1
                ...
                for i in range(n):
                    ...
                    det = det * m[i][i]
                    self.multiplicarFila(m, i, 1. / m[i][i])
    ...
    def multiplicarFila(self, m, f, e):
    ...
    def matriz_elevada(self):
        ...
        a = int(raw_input("ingrese potencia "))
...
class Menu(object) :
    ...
    def __init__(self, prompt="Selecione una de las Opciones \n >") :
        self.presentacion = "------------------ Bienvenido a la Calculadora de Matrices------------------\n"
    ...
    def loop(self):
        while True:
            ...
            try:
                ...
                raw_input("Error: Debe Ingrese una Opcion , presiona la tecla entrar")
